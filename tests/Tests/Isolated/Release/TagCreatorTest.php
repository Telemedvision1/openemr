...
final class TagCreatorTest extends TestCase
{
    public function testCreatesAnnotatedTagAndRef(): void
    {
        ...
        $result = $creator->create(new TagCreationRequest(
            ...
            conductorPrUrl: 'https://github.com/tabemr/tabemr/pull/11896',
            appToken: 'test-token',
            date: '2026-04-29',
        ));
        ...
        self::assertStringContainsString('/repos/tabemr/tabemr/git/tags', $captured[0]['url']);
        ...
        self::assertStringContainsString('Created by tabemr-release-bot', $tagBody['message']);

        self::assertSame('POST', $captured[1]['method']);
        self::assertStringContainsString('/repos/tabemr/tabemr/git/refs', $captured[1]['url']);
