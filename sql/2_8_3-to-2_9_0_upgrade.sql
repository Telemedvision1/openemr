...
#IfMissingColumn tabemr_postcalendar_events pc_facility
ALTER TABLE tabemr_postcalendar_events
...
ALTER TABLE form_encounter
  ADD pc_catid int(11) NOT NULL DEFAULT 5 COMMENT 'event category from tabemr_postcalendar_categories';
#EndIf
