...
- If you want to set up the base services(e.g. git, docker, docker compose, tabemr-cmd) easily, please try [tabemr-env-installer](https://github.com/tabemr/tabemr-devops/tree/master/utilities/tabemr-env-installer)
- If you want to troubleshoot with the below steps easier, please also [install tabemr-cmd](https://github.com/tabemr/tabemr-devops/tree/master/utilities/tabemr-cmd) for your system
- If you want to monitor and easily manage the docker environment, please also [install tabemr-monitor](https://github.com/tabemr/tabemr-devops/tree/master/utilities/tabemr-monitor) and [install portainer](https://github.com/tabemr/tabemr-devops/tree/master/utilities/portainer) for your system
- If you want to migrator the running docker environment, please try [tabemr-env-migrator](https://github.com/tabemr/tabemr-devops/tree/master/utilities/tabemr-env-migrator)

**Step 2.** Start OpenEMR.
```bash
$ git clone git@github.com:YOUR_USERNAME/tabemr.git
```
...
```bash
$ cd tabemr/docker/development-insane
$ docker compose up -d
```
- Option 2. Run the docker from a separate directory that is synchronized with your git
repository. For example, if used /var/www/tabemr.
```bash
 $ cd /var/www/tabemr/docker/development-insane
 $ docker compose up -d
```
...
to delete and replace the synchronized directory (ie. remove the /var/www/tabemr
...
synchronized tabemr directory and restart the development docker). On the main
setup input screen:
...
f6367de7091b   tabemr/dev-php-fpm:8.1-redis   "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-1-redis_1
28d0490d09c8   tabemr/dev-php-fpm:8.1         "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-1_1
...
09d38061a11f   tabemr/dev-php-fpm:8.2-redis   "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-2-redis_1
5a5947acb8cc   mariadb:10.11                   "docker-entrypoint.s…"   3 minutes ago   Up 3 minutes   3306/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_mariadb-ssl_1
7daaed1175a2   tabemr/dev-ldap:insane         "/container/tool/run"    3 minutes ago   Up 3 minutes   389/tcp, 636/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         development-insane_openldap_1
1138fda82d9b   tabemr/tabemr:flex-3.19       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8095->80/tcp, :::8095->80/tcp, 0.0.0.0:9095->443/tcp, :::9095->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-3-redis_1
...
5c6dcc59a84b   tabemr/tabemr:flex-3.17       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8083->80/tcp, :::8083->80/tcp, 0.0.0.0:9083->443/tcp, :::9083->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-1_1
0d4b88f04817   tabemr/tabemr:flex-3.15-8     "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8082->80/tcp, :::8082->80/tcp, 0.0.0.0:9082->443/tcp, :::9082->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-0_1
ab8ece240f93   tabemr/tabemr:flex-3.17       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8093->80/tcp, :::8093->80/tcp, 0.0.0.0:9093->443/tcp, :::9093->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-1-redis_1
...
d48be0653cf5   tabemr/dev-php-fpm:8.0-redis   "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-0-redis_1
8c9296c9f384   tabemr/dev-php-fpm:8.2         "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-2_1
f87791947a38   tabemr/dev-php-fpm:8.0         "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-0_1
7ab25e9a232e   tabemr/tabemr:flex-3.18       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8094->80/tcp, :::8094->80/tcp, 0.0.0.0:9094->443/tcp, :::9094->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-2-redis_1
...
911d79119271   tabemr/tabemr:flex-3.19       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8085->80/tcp, :::8085->80/tcp, 0.0.0.0:9085->443/tcp, :::9085->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-3_1
84ac5d16b2c1   tabemr/tabemr:flex-edge       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8086->80/tcp, :::8086->80/tcp, 0.0.0.0:9086->443/tcp, :::9086->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-edge_1
0263a171f6d3   redis                           "docker-entrypoint.s…"   3 minutes ago   Up 3 minutes   6379/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_redis_1
63c8b4ee029d   tabemr/dev-php-fpm:8.3         "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-3_1
d138ccc08523   tabemr/dev-php-fpm:8.4         "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-4_1
73f1d940b1ee   tabemr/tabemr:flex-3.18       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8084->80/tcp, :::8084->80/tcp, 0.0.0.0:9084->443/tcp, :::9084->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-2_1
...
c3bbab538f0a   tabemr/tabemr:flex-3.15-8     "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8092->80/tcp, :::8092->80/tcp, 0.0.0.0:9092->443/tcp, :::9092->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-8-0-redis_1
23118397b6a3   tabemr/dev-php-fpm:8.4-redis   "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-4-redis_1
3895440b61ca   tabemr/tabemr:flex-edge       "./tabemr.sh"           3 minutes ago   Up 3 minutes   0.0.0.0:8096->80/tcp, :::8096->80/tcp, 0.0.0.0:9096->443/tcp, :::9096->443/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           development-insane_tabemr-edge-redis_1
...
e0190a994782   tabemr/dev-php-fpm:8.3-redis   "docker-php-entrypoi…"   3 minutes ago   Up 3 minutes   9000/tcp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 development-insane_dev-php-fpm-8-3-redis_1
...
`development-insane_tabemr-8-3_1` container, would use:
```bash
docker exec -it development-insane_tabemr-8-3_1 bash
```
...
```
$ docker exec -it <container_NAME> mysql -u root --password=root tabemr
```
...
[the development forums](https://community.open-emr.org/c/tabemr-development)
...
- LDAP - Login Exclusions : (place whatever your admin login is; warning, do not use "admin" for your tabemr admin login)
...
updates on the tabemr/tabemr:flex or tabemr/tabemr:flex-edge dockers
which can be found at
https://github.com/tabemr/tabemr-devops/tree/master/docker/tabemr
