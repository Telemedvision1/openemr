...
<script>
    ...
    " left join tabemr_postcalendar_categories on fe.pc_catid=tabemr_postcalendar_categories.pc_catid  WHERE fe.group_id = ? order by fe.date desc", [$groupData['group_id']]);
    ?>
