                    ...
                    if (is_uploaded_file($_FILES['userfile']['tmp_name'])) {
                        ...
                        if ($fhcsv) {
                            ...
                            if ($form_vendor == '1235186800') {
                                        ...
                                        if (empty($trow['procedure_type_id']) || $trow['activity'] == 0) {
                                            if (empty($trow['procedure_type_id'])) {
                                                $ptid = sqlInsert(
                                                    ...
                                                    [$form_group, $acsv[1], $lab_id, $acsv[0], 'ord']
                                                );
                                            } else {
                                                ...
                                                sqlStatement(
                                                    ...
                                                    [$form_group, $acsv[1], $lab_id, $acsv[0], 'ord', $ptid]
                                                );
                                            }
                                        ...
                                        if (empty($trow['procedure_type_id']) || $trow['activity'] == 0) {
                                            if (empty($trow['procedure_type_id'])) {
                                                ...
                                                sqlStatement(
                                                    ...
                                                    "parent = ?, name = ?, lab_id = ?, procedure_code = ?, procedure_type = ?, " .
                                                    "activity = 1 WHERE procedure_type_id = ?",
                                                    [$ptid, $acsv[3], $lab_id, $acsv[2], 'res', $resid]
                                                );
                                            }
                                        } // end if
                                    } // end while
                                ...
                                activity = 1, seq = ?",
                                                        [$lab_id, $code, $acsv[1], $acsv[2], $required, $maxsize, $fldtype, $acsv[3], $seq]
                                                    );
                                        } else {
                                                    sqlStatement(
                                                        ...
                                                        "lab_id = ? AND procedure_code = ? AND question_code = ?",
                                                        [$acsv[2], $required, $maxsize, $fldtype, $acsv[3], $seq,
                                                        $lab_id,
                                                        $code,
                                                        $acsv[1]]
                                                    );
