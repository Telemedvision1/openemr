...
> **TelemedVision fork:** All clinic customizations live on the [`telemedvision/main`](https://github.com/Telemedvision1/openemr/tree/telemedvision/main) branch. Switch to it before making changes.
